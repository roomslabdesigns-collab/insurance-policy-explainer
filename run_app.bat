...
start "Insurance Policy Explainer - LLM Server" cmd /k ".\venv\Scripts\python.exe -m llama_cpp.server --model models\qwen2.5-3b-instruct-q4_k_m.gguf --n_ctx 2048 --host 127.0.0.1 --port 8000"

echo Waiting ~25 seconds for the (larger) model to finish loading...
